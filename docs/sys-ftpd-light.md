[[sys-ftpd-light](https://github.com/cathery/sys-ftpd)]{https://github.com/cathery/sys-ftpd/|right|rounded|bounce|success} is a lightweight FTP server that runs in the background on your Nintendo Switch
